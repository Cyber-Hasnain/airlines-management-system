...
public class AddPassengerFrame extends JFrame {
    ...
    public AddPassengerFrame(PassengerTableFrame parentFrame) {
        this.parentFrame = parentFrame;
        passengerController = new PassengerController();

        setTitle("AeroUET - Add Passenger");
        setSize(400, 520);
        ...
        JLabel titleLabel = new JLabel("Add New Passenger", SwingConstants.CENTER);
        ...
        gbc.gridy = 2;
        formPanel.add(createFieldLabel("CNIC (e.g. 12345-1234567-1 or 13 digits)"), gbc);
        gbc.gridy = 3;
    ...
    private void handleSave(ActionEvent e) {
        ...
        String result = passengerController.validateAndAdd(name, cnic, passport, gender, phone, email);
